  ...
  return data ? (
    <div className="relative ">
      ...
      <div className="text-center mt-20 text-gray-600">
        ...
        <h1 className="text-2xl sm:text-5xl font-semi-bold max-w-2xl mx-auto text-gray-800">{data.title}</h1>
      ...
      <div>
        ...
        {/* Ending comment section  */}

        {/* start comment form */}
        <div className="max-w-3xl mx-auto">
          <p className="font-semibold mb-4">Add your comment</p>
          <form onSubmit={addComment} className="flex flex-col items-start gap-4 max-w-lg">
            <input type="text" placeholder="Name" value={name} onChange={(e) => setName(e.target.value)} required className="w-full p-2 border border-gray-300 rounded outline-none" />
